...
#echo GL_DIR_FS_APP;
#echo '1';
#echo '/home/josetorresunat/zetadmision/';

#echo GL_DIR_FS_APP.'funciones/conectarmyzet.php';
#echo 'hola';
include_once(GL_DIR_FS_APP.'funciones/conectarmyzet.php');
include_once(GL_DIR_FS_APP.'funciones/funcionesmy.php');
#include_once(GL_DIR_FS_APP.'funciones/fun.php');
$cn = conectar();
$cnzet = conectar();
#echo 'paso';
#echo 'hola';		
...
#{
#    date_default_timezone_set('America/Lima'); // insert here default timezone
#}
$msgerror='';
$nerror='';
#$vcolacion='iso-8859-1';
#echo $vcolacion;
...
<link rel="icon" href="<?php echo GL_DIR_WS_HTTP_APP?>zet/unat.ico">
...
<div class="wrapper" <?php echo $msgerror!=''?' style="display:none"':''?>>
  ...
  <div class="header_bar">
    ...
    <div class="brand">
      ...
      <img src="<?php echo GL_DIR_WS_HTTP_APP?>imageneszet/unat_logo.gif" alt="r-logo" /></div>
    </div>
    <!--\\\\\\\ brand end \\\\\\-->
    <div class="header_top_bar">
      ...
      <div class="top_left">
        ...
        <div class="user_admin dropdown" style="width: 320px;"> <a href="javascript:void(0);" data-toggle="dropdown"><img src="<?php echo GL_DIR_WS_HTTP_APP?>imageneszet/siga.png" />
         <span class="user_adminname">
		  <?php 
			...
			{
		  		echo substr($nombrecompleto,0,30).'...'; 
			}
		  ?>
