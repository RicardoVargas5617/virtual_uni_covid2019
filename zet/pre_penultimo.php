...
<table width="650" border="0" align="center" cellpadding="3" cellspacing="0" class="table-borderless">
    ...
    <tr>
        ...
        <td>
        	<input type="text" name="txtFechaNacimiento" id="txtFechaNacimiento" class="form-control validar" autocomplete="off" autocapitalize="words"  value="" maxlength="50"  placeholder="Ingresar email" aria-describedby="txtnombre-message">
        </td>    
    </tr>
    <tr>
    	<td>
