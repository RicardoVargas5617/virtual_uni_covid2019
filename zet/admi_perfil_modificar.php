<?php 
	...
	$cnzet = conectar();
	$codigo = $_GET["codigo"];
	$vsql = "call zyz_Man_Perfil ('". $codigo . "','',0,'M')";
	//echo $vsql;
...
<div class="row">
  ...
  <div class="header">
  	<div class="actions"> 
        <a data-atras="SI" href="admi_perfil.php?d=<?php echo $_REQUEST['d']?>&nav=<?php echo $nav?>&codigo=<?php echo $codigo;?>"><i class="fa fa-mail-reply"></i>
    	</a>
    </div>
