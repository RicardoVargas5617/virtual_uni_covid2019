...
<form action="pregrabar_prueba.php" method="post" id="grado" name="frmFotoGrado" enctype="multipart/form-data" onsubmit="return true;" >
   <center><h3>INSCRIPCIÓN EXAMEN <u><strong>CEPRE-PRUEBA</strong></u> ADMISIÓN UNAJMA</h3><h4 style="font-size:22px;">2021 - I</h4> </center> 
    ...
    <div class="seccion-contenedor">        
        <div class="card text-center" style="width: 18rem;">
            <div class="card-body">
                ...
                <p class="card-text">Las inscripciones para el examen de PRUEBA - CEPRE 2021-1 </br> FINALIZARÓN A LAS 13:00 PM</p>
