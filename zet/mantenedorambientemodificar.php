<?php 
	...
	$vsql = "call zyz_CAMantenedorAmbiente ('". $codigo . "','". $local . "','',0,'','',0,'M')";
	//echo $vsql;	
...
<table class="table">
    ...
    <tr>
        ...
        <td>
            <input name="txtCapacidad" id="txtCapacidad" data-requerido="true" data-requerido-texto="Descripcion" type="text" value="<?php echo $capacidad ?>" size="70">
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <input name="txtObservacion" type="text" value="<?php echo $observacion ?>" size="70">
        </td>
    </tr>
    <tr>
        <td>
