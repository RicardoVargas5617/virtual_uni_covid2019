...
<table width="1200" border="1">
	<tr>
    	...
    	<td width="12%" colspan="3" align="center"><strong>Aptitud Académica</strong></td>
    	<td width="12%" colspan="3" align="center"><strong>Conocimientos</strong></td>
        ...
        <td width="10%" rowspan="2" align="center"><strong>Observación</strong></td>
	</tr>
	<tr>
	...
	{ 
		...
		echo '<tr>';
			...
			echo '</td>';
			echo '<td align="right">';
				echo '<strong style="font-size:12px;">'.$rsjk[5].'</strong>';
			echo '</td>';			
			echo '<td align="left">';
				echo $rsjk[3];
			echo '</td>';			
