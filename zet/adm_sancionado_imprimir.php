<?php
	...
	#$vsql = "call zyz_CAAdmisionReporte ('". $proceso . "', '','', 'S1')";
...
<table width="750" border="1" style="border-collapse:collapse">
	<tr>
    	...
    	<td width="15%" align="center"><strong>Escuela</strong></td>
    	<td width="35%" align="center"><strong>Observacion</strong></td>
	</tr>
	<?php
	$contador = 0;
