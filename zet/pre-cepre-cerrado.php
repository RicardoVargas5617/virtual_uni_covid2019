...
<form action="pregrabar-cepre.php" method="post" id="grado" name="frmFotoGrado" enctype="multipart/form-data" onsubmit="return true;" >
   <center><h3>INSCRIPCIÓN EXAMEN CEPRE ADMISIÓN UNAJMA</h3><h4 style="font-size:22px;">2021 - I</h4> </center> 
    ...
    <tr>
        ...
        <td>
            ...
            <select name="cboModalidad" id="cboModalidad">
                <option value="03">2. CENTRO PRE</option>
            </select>
        </td>    
    </tr>  
    <tr>
