...
<div class="row">
  ...
  <div class="porlets-content">
	<form  name="form" class="form-horizontal row-border" method="post" id="frmcronmod" action="adm_proceso_ponercero_grabar.php?d=<?php echo $_GET['d']?>&nav=<?php echo $_GET['nav']?>" onsubmit="grabar(this.id);return false;">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-9">
          <ul>
          	<li>Eliminar respuestas</li>
            <li>Eliminar estructura de preguntas por postulante</li>
            <li>Poner a 0 ingresos y logeos</li>
            <li>Poner a 0 puntajes</li>
          </ul>
        </div>
      </div><!--/form-group--> 
