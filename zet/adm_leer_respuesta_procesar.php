<?php 
	...
	#exit;
	$vsql = "delete from adm_importar_respuesta";
	#echo $vsql;
	#exit;
	...
	$vsql = "insert into adm_importar_respuesta (proceso, orden) values ";
	while(!feof($fprespuesta))  
			{
					...
					$vsql = $vsql . "(" . "'" . $proceso . "', " . "'" . $order . "') "; 
			}
	#echo $vsql;
	mysqli_query($cnzet, $vsql);
	fclose($fprespuesta);

	$vsql = "call zyz_CAImportarRespuesta('". $usuario . "','". $persona . "','". $proceso . "')";
	#echo $vsql;
	#exit;
