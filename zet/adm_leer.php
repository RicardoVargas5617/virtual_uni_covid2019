...
<ul class="list-group">
    <li class="list-group-item">
        <a href="javascript:ventanaSecundaria('<?php echo GL_DIR_WS_HTTP_APP?>zet/adm_leer_identificacion.php?proceso=<?php echo $proceso ?>')">
        Leer identificaci&oacute;n
        </a> 
    </li>  
    <li class="list-group-item"> 
        <a href="javascript:ventanaSecundaria('<?php echo GL_DIR_WS_HTTP_APP?>zet/adm_leer_clave.php?proceso=<?php echo $proceso ?>')">
        Leer claves
        </a> 
    </li>
    <li class="list-group-item">
        <a href="javascript:ventanaSecundaria('<?php echo GL_DIR_WS_HTTP_APP?>zet/adm_leer_respuesta.php?proceso=<?php echo $proceso ?>')">
        Leer respuesta
        </a> 
    </li>    
</ul>
