<?php 
	...
	$vsqltipoproceso = "select tipoproceso, descripcion from adm_tipoproceso where activo=1 order by descripcion";	
	$vsqlsemestre = "select semestre, semestre from mae_semestre where activo=1 order by semestre desc";
	$vsqlproceso = "select procesogeneral, descripcion from adm_procesogeneral where activo=1 order by descripcion";
?>
<div class="row">
  <div class="block-web">
  <div class="header">
	...
	<form  name="form" class="form-horizontal row-border" method="post" id="frmcronmod" action="adm_proceso_grabar.php?d=<?php echo $_GET['d']?>&nav=<?php echo $_GET['nav']?>" onsubmit="grabar(this.id);return false;">
      ...
      <div class="form-group">
 	  ...
 	  <div class="form-group">
        ...
        <div class="col-sm-9">
        <input type="text" class="form-control" value="4.039" name="txtPreguntaBuena" id="txtPreguntaBuena" data-requerido="true" data-requerido-texto="Pregunta Buena">
        </div>
      </div><!--/form-group--> 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
        <input type="text" class="form-control" value="-0.151" name="txtPreguntaMala" id="txtPreguntaMala" data-requerido="true" data-requerido-texto="Pregunta Mala">
        </div>
      </div><!--/form-group-->       
