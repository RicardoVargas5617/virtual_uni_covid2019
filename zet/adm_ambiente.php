...
<table width="1200" border="1">
	<tr>
        ...
        <td width="8%" align="center"><strong>Foto</strong></td>
    	<td width="6%" align="center"><strong>C&oacute;digo</strong></td>	
        ...
        <td width="15%" align="center"><strong>Email</strong></td>
        <td width="12%" align="center"><strong>Celular</strong></td>
	</tr>
	<?php
	$contador = 0;
