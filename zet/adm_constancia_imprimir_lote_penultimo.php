<?php
	...
	$vsql = "call zyz_CAConstancia ('". $proceso . "', '','". $pos . "', '". $tipito . "', '', 'C')";
	$rs_zet = mysqli_query($cn_zet, $vsql);
	$total = mysqli_num_rows($rs_zet); 
    ...
    while ($rsjk_zet=mysqli_fetch_row($rs_zet))
		...
		<table width="750">
			<tr>
				<td align="center">
					<span style="font-size:22px;font-weight:bold">CONSTANCIA DE INGRESO</span>
				</td>
			</tr>
			<tr>
				<td align="center">
					<span style="font-size:18px;font-weight:bold">PROCESO DE ADMISI&Oacute;N 2020-1</span>
				</td>
			</tr>
		</table>
		';
			...
			<table width="750" border="0">
				...
				<tr>
					<td align="left" colspan="2">
						...
						<br>
						<span style="font-size:16px; font-weight:bold">
						Ha ingresado a la Universidad Nacional Jos&eacute; Mar&iacute;a Arguedas Daniel Hern&aacute;ndez Morillo para continuar sus estudios universitarios en la:
						</span>
					</td>
				</tr>
				<tr height="60">
