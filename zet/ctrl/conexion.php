<?php
	...
	const DB="admision_zet"; // unajmadm_prueba
	const USER="admision_zet"; //unajmadm_prueba
	const PASS="carlsen2020"; //npHl;Y540,ni
    ...
    class mainModel{
        ...
        public function insert_tbl($dni, $nombre, $tipo){
            $query1 = "INSERT INTO control_ventana (id, dni, nombre, tipo, anio, fecha) VALUES (NULL, '$dni','$nombre', '$tipo', '2020', CURRENT_TIMESTAMP)";
         ...
         * 
         */
        public function obtener_tbl($dnis){
            $query = "SELECT * FROM control_ventana ORDER BY fecha_hora desc LIMIT 50";
